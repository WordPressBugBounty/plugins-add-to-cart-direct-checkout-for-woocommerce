...
class Pi_Dcw_Pro_Woo {
	...
	function order_preparation_days() {
			...
			woocommerce_wp_text_input( 
					array( 
						'id'      => 'pi_dcw_product_custom_thanyou_page_url', 
						'label'   => __( 'Custom Thank you page url', 'woocommerce' ), 
						'type' => 'url',
						'custom_attributes' => ['disabled' => true]
						)
					);
			...
			<div id="pi-pro-buy">
				<div id="pi-buy-now">
					<h2>BUY PRO VERSION OF<br>DIRECT CHECKOUT FOR<br><span class="pi-price"><?php echo esc_html( PI_DCW_PRICE ); ?></span><br> then you can overwrite global redirect setting</h2>
				</div>
				<div id="pi-buy-container">
				<a href="<?php echo esc_url( PI_DCW_BUY_URL ); ?>" id="pi-buy-button">BUY NOW</a>	
				</div>
			</div>
				<?php
			}
