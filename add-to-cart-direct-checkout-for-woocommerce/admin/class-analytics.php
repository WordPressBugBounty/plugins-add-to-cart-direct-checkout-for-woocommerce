...
class Pi_Dcw_Analytics{
    ...
    public function show_tracker_notice() {
        ...
        $notice .= '<p>'.__("Hi, your support can make a big difference!", 'pi-dcw').'</p>';
        $notice .= '<p>'.__("We collect only technical data — including the plugin version, WordPress version, WooCommerce version, and site url — solely to improve compatibility and enhance plugin features.", 'pi-dcw').'</p>';
...
new Pi_Dcw_Analytics(
    'WooCommerce Direct checkout',
    'add-to-cart-direct-checkout-for-woocommerce/pi-dcw.php',
    PI_DCW_VERSION
);